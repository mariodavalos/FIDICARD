//
//  detalleTarjtVirtualViewController.swift
//  FIDICARD
//
...
class detalleTarjtVirtualViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        lblNumTarjeta.text = tarjeta.numero
    ...
    @IBAction func goToPromos(sender: AnyObject) {
        ...
        if let sv = self.revealViewController(){
            ...
            vc.senderID = "detalleTarjtVirtualViewController"
            vc.tarjeta = self.tarjeta
    ...
    @IBAction func goToSucursales(sender: AnyObject) {
        ...
        if let sv = self.revealViewController(){
            ...
            vc.tarjeta = self.tarjeta
            vc.senderVC = "detalleTarjtVirtualViewController"
            vc.padreSenderVC = senderVC
            //sv.pushFrontViewController(vc, animated: true)
            self.navigationController?.pushViewController(vc, animated: true)
        }
    ...
    @IBAction func toggleNotification(sender: AnyObject) {
        ...
        if notSwitch.on {
            ...
            let newTodo = ["email": String(user.email!),"marca_id" : self.tarjeta.marca_id , "activa" : 1]
            ...
            let todosEndpoint: String = "http://201.168.207.17:8888/fidicard/kuff_api/toggleNotifMarca"
            let newTodo = ["email": String(user.email!),"marca_id" : self.tarjeta.marca_id , "activa" : 0]
